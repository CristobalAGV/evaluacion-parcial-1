...
# evaluacion_parcial_1 documentation build
...
from evaluacion_parcial_1 import __version__ as release

# -- Project information -----------------------------------------------------

project = "evaluacion_parcial_1"
author = "Kedro"
...
htmlhelp_basename = "evaluacion_parcial_1doc"
...
latex_documents = [
    (
        master_doc,
        "evaluacion_parcial_1.tex",
        "evaluacion_parcial_1 Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "evaluacion_parcial_1",
        "Project evaluacion_parcial_1 codebase.",
        "Data-Science",
    )
]
